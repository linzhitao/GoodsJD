...
IF EXIST "%SONAR_RUNNER_HOME%\lib\sonar-scanner-cli-2.5.1.jar" goto run
...
@REM ==== START RUN ====
:run
@REM echo %SONAR_RUNNER_HOME%

set PROJECT_HOME=%CD%

%JAVA_EXEC% -Djava.awt.headless=true %SONAR_RUNNER_OPTS% -cp "%CD%\qf.jar" "-Drunner.home=%SONAR_RUNNER_HOME%" "-Dproject.home=%PROJECT_HOME%" org.sonarsource.scanner.cli.Main %*
